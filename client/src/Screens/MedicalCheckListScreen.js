...
function MedicalCheckListScreen() {
    ...
    axios
        ...
        .catch((error) => setShowLoading(false), console.log("Fail"))
    };

    const handleInputChange = (event) => {
        event.persist()
        if (event.target.id === 'male' || event.target.id === 'yes') {
            event.target.value = 1
        }
        else if (event.target.id === 'female' || event.target.id === 'no') {
                ...
                {output && !showLoading && (
                    <Table
                        ...
                        <tr class = "border-table">
                            <td class="border-table">{data.row1[0]}</td>
                            <td class="border-table">{data.row1[1]}</td>
                        </tr>
                        <tr class="border-table">
                            <td class="border-table">{data.row2[0]}</td>
                            <td class="border-table">{data.row2[1]}</td>
                        </tr>
                        <tr class="border-table">
                            <td class="border-table">{data.row3[0]}</td>
                            <td class="border-table">{data.row3[1]}</td>
                        </tr>
                    </Table>
                )}
            </center>
